...
sudo pacman -S vim neovim tmux neofetch alacritty zsh i3-wm i3status dmenu rofi ttf-jetbrains-mono-nerd npm xterm xorg xorg-xinit xf86-video-intel xorg-server xclip wget firefox keepassxc unzip openssh htop vlc --noconfirm
